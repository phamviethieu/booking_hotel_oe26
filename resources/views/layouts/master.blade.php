...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('bower_components/style_project1/css/bootstrap-submenu.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('bower_components/style_project1/css/bootstrap-select.min.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('bower_components/style_project1/fonts/font-awesome/css/font-awesome.min.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('bower_components/style_project1/fonts/flaticon/font/flaticon.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('bower_components/style_project1/fonts/linearicons/style.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('bower_components/style_project1/fonts/css/jquery.mCustomScrollbar.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('bower_components/style_project1/css/bootstrap-datepicker.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css" id="style_sheet"
          href="{{ asset('bower_components/style_project1/css/skins/blue-light-2.css') }}">
...
<!--[if lt IE 9]><script  src="{{ asset('bower_components/style_project1/js/ie8-responsive-file-warning.js') }}"></script><![endif]-->
