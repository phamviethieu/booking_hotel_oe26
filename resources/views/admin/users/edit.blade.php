                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item text-muted" contenteditable="false">
                                <strong> {{ trans('message.infor_user.info') }}&#58; {{ $user->name }} </strong> &nbsp;
                                <div class="float-right">
                                    <a title="{{ trans('message.cancel') }}" href="{{ route('users.index', $user->id) }}">
                                        <i class="far fa-window-close"></i>
                                    </a>
                                </div>
                            </li>
                            <li class="list-group-item "><span class="pull-left">
                                <strong class=""> {{ trans('message.infor_user.fullName') }}
                                <span class="text-danger">&#42; </span>&#58; </strong>
                                </span>&nbsp;
                                <input class="user-input" type="text" required name="name" value="{{ $user->name }}">
                            </li>
                            <li class="list-group-item "><span class="pull-left">
                                <strong class="">{{ trans('message.infor_user.join') }}&#58; </strong></span>
